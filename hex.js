['#000000', '#000080', '#00008B', '#0000CD', '#0000FF', '#006400', '#008000', '#008080', '#008B8B', '#00BFFF', '#00CED1', '#00FA9A',
	...
	'#FF8C00', '#FFA500', '#FFD700', '#FFFF00', '#FFA07A', '#FFB6C1', '#FFC0CB', '#FFDAB9', '#FFDEAD', '#FFEFD5']
				  ...
				  //deep pink, blue violet, indigo,   salmon,     red,    dark orange, 
	var easyDeck = ['#FF1493', '#8A2BE2', '#4B0082', '#FA8072', '#FF0000', '#FF8C00',
	// yellow, saddleBrown, maroon, chartreuse, mediumSeaGreen, darkGreen, aqua
	'#FFFF00', '#8B4513', '#800000', '#7FFF00', '#3CB371', '#006400', '#00FFFF',
